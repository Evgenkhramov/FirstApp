...
namespace FirstApp.Core.ViewModels
{
    public class MainViewModel : MvxViewModel
    {
        ...
        public MainViewModel(IMvxNavigationService navigationService, ISQLiteRepository sQLiteRepository)
        {
           ...
           ShowMenuFragmentCommand = new MvxAsyncCommand(async () => await _navigationService.Navigate<MenuFragmentViewModel>());
        }
        public IMvxAsyncCommand ShowMainFragmentCommand { get; private set; }
        public IMvxAsyncCommand ShowMenuFragmentCommand { get; private set; }
    }   
}
